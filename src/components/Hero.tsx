      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="mt-20 md:mt-32 px-6 sm:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Column 1 */}
            <div className="bg-vt-pink/45 backdrop-blur-sm p-6 rounded-lg">
            ...
            {/* Column 2 */}
            <div className="bg-vt-blue/45 backdrop-blur-sm p-6 rounded-lg">
              <h3 className="text-xl font-bold text-white font-lexend-deca mb-3">
                The Right Roadmap
              </h3>
              <p className="text-white font-lexend-deca">
            ...
            {/* Column 3 */}
            <div className="bg-vt-green/45 backdrop-blur-sm p-6 rounded-lg">
              <h3 className="text-xl font-bold text-white font-lexend-deca mb-3">
                Better Outcomes
              </h3>
              <p className="text-white font-lexend-deca">
