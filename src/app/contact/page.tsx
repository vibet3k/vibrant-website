        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-2 flex flex-col justify-center space-y-10 lg:pr-8">
            ...
            <div className="grid grid-cols-1 gap-8 mt-8">
              ...
              <div className="bg-vt-green/30 backdrop-blur-sm p-4 rounded-lg flex items-start gap-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-x-1">
              ...
              <div className="bg-vt-pink/30 backdrop-blur-sm p-4 rounded-lg flex items-start gap-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-x-1">
          ...
          {/* Contact form (3 columns) - with top margin to push it down independently */}
          <div className="lg:col-span-3 px-0 sm:px-8 lg:self-start lg:mt-8">
