    ...
    <BackgroundLayout>
      <main className="mx-auto px-6 py-16">
        <div className="bg-white/95 backdrop-blur-md rounded-lg shadow-xl p-10 min-h-[600px] w-[900px] max-w-full mx-auto">
          <div className="mb-8 pb-4 border-b-2 border-gradient-to-r from-vt-blue to-vt-pink">
          ...
          {posts.length > 0 ? (
              ...
              {posts.map((post: Post) => (
                <div key={post._id || (typeof post.slug === 'string' ? post.slug : post.slug?.current)} 
                  ...
                  <Link 
                    ...
                    className="inline-block mt-3 text-vt-blue hover:text-vt-pink transition-colors"
                  >
                    Read more →
                  </Link>
                </div>
            ...
            <div className="my-6 p-4 bg-vt-blue/10 rounded-lg">
